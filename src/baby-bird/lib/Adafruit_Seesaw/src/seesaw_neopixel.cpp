...
seesaw_NeoPixel::seesaw_NeoPixel(uint16_t n, uint8_t p, neoPixelType t, TwoWire *Wi) : Adafruit_Seesaw(Wi),
...
seesaw_NeoPixel::seesaw_NeoPixel(TwoWire *Wi) : Adafruit_Seesaw(Wi),
#ifdef NEO_KHZ400
                                                is800KHz(true),
#endif
